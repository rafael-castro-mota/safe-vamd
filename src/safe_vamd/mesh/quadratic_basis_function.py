...
class QuadBasisFunc(MathFunc):
    """
    Piece-wise quadratic basis function associated with a selected node in an element,
    ...
    **Class attributes:**
    ...
    node_coords : Sequence[float]
        List of z-coordinates (height, in :math:`m`) for the element's nodes.
    ...
    def value(self, z: ArrayLike) -> np.ndarray:
        """
        Evaluates the piece-wise quadratic basis function at z(s).
    ...
    def dvalue(self, z: ArrayLike) -> np.ndarray:
        """
        Evaluates the derivative of the piece-wise quadratic basis function at z(s).
        ...
        -------
        float
            Value(s) of the derivative of the piece-wise quadratic basis function at z(s).
        """
