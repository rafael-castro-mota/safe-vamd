Example 1
==========
The large-scale, low-frequency sound propagation in https://doi.org/10.1121/10.0003567 (Figure 11),
http://dx.doi.org/10.1121/1.4976067 (Figure 7) and https://doi.org/10.1016/j.enganabound.2025.106308 (Figure 4) is
solved with the package. The problem is of particular interest because of the complex atmospheric conditions and the
resulting atmopsheric waveguides that are formed at low-, medium- and high-altitudes.
...
In this example, air absorption is not accounted for.
